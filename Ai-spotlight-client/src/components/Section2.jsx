...
const Section2 = () => {
  ...
  return (
    <div className='text-center align-center try-it'>
        <h1 className='text-6xl  max-md:text-[2rem] text-center capitalize font-medium mt-5 line-2'>
          {/* ✨Hey, you have an Product ?  */}
          ✨Hey, you have an Ai Product ? 
        </h1>
        <p className='m-10'>Use Ai Spotlights to get listed on the largest AI tools Directory<br/> Showcase your products powerful features to get a head from the competition </p>
