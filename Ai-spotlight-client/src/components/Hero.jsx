  ...
  return (
    <section className="wrapper mt-[4rem]">
      <div className="space-y-5 flex items-center justify-center flex-col my-10">
        <h2 className="text-3xl max-md:text-3xl max-md:font-medium text-center font-medium brightness-75">
          Ai Spotlights
        </h2>
        <h1 className="text-7xl  max-md:text-[2.5rem] text-center capitalize font-medium mb-50">The largest AI tools directory</h1>
