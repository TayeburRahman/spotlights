...
const Checkout = () => {
  const packageLoc = localStorage?.getItem('package');
  const packages = JSON.parse(packageLoc);
  return (
    <Fragment>
      <Container>
        ...
        <div className='mt-5'>
          <h2 className='h2- pb-5'>Get Your {packages?.package_name?.package_name} Verified (${packages?.package_name?.price})</h2>
